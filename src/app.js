 ...
 */
export class MirrorizerApp extends Component {
  state = {
    ...
    if (this.state.isAppReady) {
      ...
      return (
        <AuthScreen
          ...
          resetPassword={this._simulateResetPassword}
          isLoggedIn={this.state.isLoggedIn}
          isLoading={this.state.isLoading}
          onMirrorizerAppCompleted={() => this.setState({ isAppReady: true })}
        />
      )
    }
  }
